...
LABEL version=8.23.0 Description="For running Second Life and OpenSim automated agents based on the Corrade scripted agent system" Vendor="ICON Metaverse"

ADD [ "http://grimore.org/_media/secondlife/scripted_agents/corrade-8.23.zip", "/tmp/corrade.zip" ]
